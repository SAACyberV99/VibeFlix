...
A modern, feature-rich movie discovery application powered by The Movie Database (TMDb) API, designed with Manus AI, and built with Claude Sonnet 4.6 AI. Search, browse, sort, and explore thousands of movies with a sleek, Netflix-inspired interface.
